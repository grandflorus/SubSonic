<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="InformationEdit.aspx.cs" Inherits="Solution.Web.Managers.WebManage.Systems.Powers.InformationEdit" %>
        ...
        <Toolbars>
            <f:Toolbar ID="toolBar" runat="server">
                <Items>
                    ...
                    <f:Button ID="BtnDelPic" runat="server" Text="删除图片" Icon="Delete" OnClick="BtnDelPic_Click"
