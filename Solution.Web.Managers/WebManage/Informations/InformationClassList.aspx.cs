...
namespace Solution.Web.Managers.WebManage.Informations
{
    public partial class InformationClassList : PageBase
    {
        ...
        protected void Grid1_PreRowDataBound(object sender, FineUI.GridPreRowEventArgs e)
        {
            ...
            if (((System.Data.DataRowView)(gr.DataItem)).Row.Table.Rows[e.RowIndex][InformationClassTable.IsShow].ToString() == "0")
            {
            ...
            //绑定是否单页列
            if (((System.Data.DataRowView)(gr.DataItem)).Row.Table.Rows[e.RowIndex][InformationClassTable.IsPage].ToString() == "0")
            {
