...
<body>
    ...
    <f:panel id="Panel1" runat="server" title="信息列表" enableframe="false" bodypadding="10px"
        ...
        <items>
            <f:Form ID="Form6" ShowBorder="True" BodyPadding="5px" ShowHeader="False" runat="server">
                <Rows>
                    <f:FormRow ID="FormRow1" runat="server">
                        <Items>
                            <f:TextBox runat="server" ID="txtTitle" Label="标题" Width="260px" Text="" MaxLength="20"  />
            ...
            <f:Grid ID="Grid1" Title="信息列表" EnableFrame="false" EnableCollapse="true" AllowSorting="true" IsDatabasePaging="True"
