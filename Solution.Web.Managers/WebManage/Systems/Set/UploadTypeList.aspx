...
<body>
    ...
    <f:panel id="Panel1" runat="server" title="上传类型列表" enableframe="false" bodypadding="10px"
        ...
        <items>
            ...
            PageSize="15" ShowBorder="true" ShowHeader="False" AllowPaging="true" runat="server" EnableCheckBoxSelect="True" DataKeyNames="Id" EnableColumnLines="true" Width="780px"
