<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmpowerPhoneList.aspx.cs" Inherits="Solution.Web.Managers.WebManage.Systems.Powers.EmpowerPhoneList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>授权电话管理列表</title>
</head>
<body>
    <form id="form1" runat="server">
    <f:pagemanager id="PageManager1" runat="server" />
    <f:panel id="Panel1" runat="server" title="授权电话管理列表" enableframe="false" bodypadding="10px"
        enablecollapse="True">
        <toolbars>
        ...
        <items>
            <f:Grid ID="Grid1" Title="授权电话管理列表" EnableFrame="false" EnableCollapse="true" AllowSorting="true" IsDatabasePaging="True"
            PageSize="15" ShowBorder="true" ShowHeader="False" AllowPaging="true" runat="server" EnableCheckBoxSelect="True" DataKeyNames="Id" EnableColumnLines="true" Width="820px"
            OnPageIndexChange="Grid1_PageIndexChange" OnPreRowDataBound="Grid1_PreRowDataBound" OnRowCommand="Grid1_RowCommand" OnSort="Grid1_Sort">
                <Columns>
                    ...
                    <f:BoundField Width="100px" DataField="Manager_CName" SortField="Manager_Id" HeaderText="姓名" />
                    <f:BoundField Width="100px" DataField="Phone" SortField="Phone" HeaderText="手机号码" />
                    <f:BoundField Width="60px" DataField="Code" SortField="Code" HeaderText="识别码" />
                    <f:BoundField Width="130px" DataField="UpdateDate" SortField="UpdateDate" HeaderText="识别码下发时间" />
                    <f:BoundField Width="100px" DataField="Ip" HeaderText="登陆IP" />
