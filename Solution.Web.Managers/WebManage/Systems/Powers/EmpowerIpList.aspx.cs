...
{
    public partial class EmpowerIpList : PageBase
    {
        #region Page_Load
        ...
        protected void Grid1_RowCommand(object sender, FineUI.GridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "ButtonEdit":
                    //打开编辑窗口
                    Window1.IFrameUrl = "EmpowerIpEdit.aspx?Id=" + id + "&" + MenuInfoBll.GetInstence().PageUrlEncryptStringNoKey(id + "");
        ...
        {
            Window1.IFrameUrl = "EmpowerIpEdit.aspx?" + MenuInfoBll.GetInstence().PageUrlEncryptString();
            Window1.Hidden = false;
        }
        #endregion
        ...
        public override string Delete()
        {
            ...
            try
            {
                ...
                {
                    //删除前检查
                    //if (PagePowerSignBll.GetInstence().Exist(x => x.EmpowerIp_Id == i))
                    //{
