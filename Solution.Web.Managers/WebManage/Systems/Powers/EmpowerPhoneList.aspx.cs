...
{
    public partial class EmpowerPhoneList : PageBase
    {
        #region Page_Load
        ...
        {
            //逻辑对象赋值
            //bll = EmpowerPhoneBll.GetInstence();
            //表格对象赋值
            grid = Grid1;
        }
        #endregion
        ...
        protected void Grid1_RowCommand(object sender, FineUI.GridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "ButtonEdit":
                    //打开编辑窗口
                    Window1.IFrameUrl = "EmpowerPhoneEdit.aspx?Id=" + id + "&" + MenuInfoBll.GetInstence().PageUrlEncryptStringNoKey(id + "");
        ...
        {
            Window1.IFrameUrl = "EmpowerPhoneEdit.aspx?" + MenuInfoBll.GetInstence().PageUrlEncryptString();
            Window1.Hidden = false;
        }
        #endregion
        ...
        public override string Delete()
        {
            ...
            try
            {
                ...
                {
                    //删除前检查
                    //if (PagePowerSignBll.GetInstence().Exist(x => x.EmpowerPhone_Id == i))
                    //{
