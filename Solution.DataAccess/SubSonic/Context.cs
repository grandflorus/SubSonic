...
namespace Solution.DataAccess.DataModel
{
    public partial class SolutionDataBaseDB : IQuerySurface
    {
        ...
        public Query<DataAccess.Model.DataPassTest> DataPassTest { get; set; }
        ...
        public Query<DataAccess.Model.itcast_part> itcast_part { get; set; }
        ...
        public Query<DataAccess.Model.RainFall> RainFall { get; set; }
        public Query<DataAccess.Model.ResultTest> ResultTest { get; set; }
        public Query<DataAccess.Model.supplier_info> supplier_info { get; set; }
        ...
        void Init()
        {
            ...
            DataPassTest = new Query<DataAccess.Model.DataPassTest>(provider);
            ...
            itcast_part = new Query<DataAccess.Model.itcast_part>(provider);
            ...
            RainFall = new Query<DataAccess.Model.RainFall>(provider);
            ResultTest = new Query<DataAccess.Model.ResultTest>(provider);
            supplier_info = new Query<DataAccess.Model.supplier_info>(provider);
        	...
        	if(DataProvider.Schema.Tables.Count == 0)
			{
            	...
            	DataProvider.Schema.Tables.Add(new DataPassTestStructs(DataProvider));
            	...
            	DataProvider.Schema.Tables.Add(new itcast_partStructs(DataProvider));
            	...
            	DataProvider.Schema.Tables.Add(new RainFallStructs(DataProvider));
            	DataProvider.Schema.Tables.Add(new ResultTestStructs(DataProvider));
            	DataProvider.Schema.Tables.Add(new supplier_infoStructs(DataProvider));
