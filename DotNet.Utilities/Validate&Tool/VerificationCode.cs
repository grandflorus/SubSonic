...
namespace DotNet.Utilities
{
    ...
    public class VerificationCode
    {
        ...
        private Bitmap tempImage()
        {
            ...
            {
                Font[] fonts = {
                            new Font(new FontFamily("NSimSun"), RandomHelper.GetRndNext(FontSize - 2, FontSize), FontStyle.Bold),
                            new Font(new FontFamily("NSimSun"), RandomHelper.GetRndNext(FontSize - 3, FontSize), FontStyle.Bold),
