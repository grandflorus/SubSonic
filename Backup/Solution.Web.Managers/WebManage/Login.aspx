...
<body>
    ...
    <div>
        <label>
            本框架不内置 ExtJS 库，所以运行后会出现：ERROR: extjs folder is lost! 这个错误，点击确认后自动跳转到ExtJS 库下载地址，请自行下载后手工添加到Solution.Web.Managers项目的根目录中即可正常运行</label>
    </div>
    <f:PageManager ID="PageManager1" AutoSizePanelID="regionPanel" runat="server" />
    <f:Panel ID="Panel2" runat="server" Title="登陆授权" EnableFrame="True" BodyPadding="10px" Width="350px" CssStyle="margin:150px auto;" Hidden="True">
        <Items>
            <f:SimpleForm ID="SimpleForm2" runat="server" ShowBorder="false" BodyPadding="10px"
                LabelWidth="80px" ShowHeader="false">
                <Items>
                    <f:TextBox ID="TextBox1" Label="手机号码" runat="server" Height="32px">
                    </f:TextBox>
                    <f:TextBox ID="TextBox2" Label="手机验证码" runat="server" Height="32px">
                    </f:TextBox>
                </Items>
            </f:SimpleForm>
        </Items>
        <Toolbars>
            <f:Toolbar ID="Toolbar2" runat="server" Position="Footer">
                <Items>
                    <f:Button ID="Button4" Text="获取手机验证码" Type="Submit" ValidateForms="SimpleForm1" ValidateTarget="Top"
                        runat="server" OnClick="BtnLogin_Click">
                    </f:Button>
                    <f:Button ID="Button2" Text="提交" Type="Submit" ValidateForms="SimpleForm1" ValidateTarget="Top"
                        runat="server" OnClick="BtnLogin_Click">
                    </f:Button>
                    <f:Button ID="Button3" Text="重置" Type="Reset" EnablePostBack="false" runat="server">
                    </f:Button>
                </Items>
            </f:Toolbar>
        </Toolbars>
